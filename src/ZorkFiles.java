...
public class ZorkFiles {
	...
	private static void formatWrite(String str, double money) {

		String roomHistory = str + "\t";
		String moneyStr;

		Locale locale = new Locale("en", "US");

		NumberFormat currencyFormatter = NumberFormat.getCurrencyInstance(locale);
		moneyStr = currencyFormatter.format(money);
		roomHistory = roomHistory + moneyStr;

		writeHistory(roomHistory);
	}


	private static void writeHistory(String history) {  

		try {


			FileWriter file = new FileWriter("history", true);
	...
	private static void printTheFile() {
		...
		try {
			...
			System.out.println("Oops! File read error.");
		}
